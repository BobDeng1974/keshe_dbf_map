...
public class BuildFrameUtil {
	...
	String string = "";
	switch (type) {
	case BluetoothConstant.TYPE_GETFI_FLRD:
	    string = "FLRD" + fileName;
	    break;
	case BluetoothConstant.TYPE_SndFlNm_YFLSDOK:
	    string = "YFLSDOK";
	    break;
	case BluetoothConstant.TYPE_SndData_YFD:
	    ...
	    return messageByte;
	case BluetoothConstant.TYPE_SndFlEnd_FLRE:
	    string = "FLRE";
	    break;
	default:
	    break;
	...
	if (type == BluetoothConstant.TYPE_SndData_YFD) {
	...
	if ((message[0] == 'F') && (message[1] == 'L') && (message[2] == 'S')
		&& (message[3] == 'D')) {
	    sppMessage = new SppMessage(BluetoothConstant.TYPE_FLSD, 0, 0,
		    sDataLen - 4);
	...
	// FD
	    ...
	    sppMessage = new SppMessage(BluetoothConstant.TYPE_FD, message[2],
	...
	// FLSE
	    ...
	    sppMessage = new SppMessage(BluetoothConstant.TYPE_FLSE, 0, 0, 0);
	}
	// YFLRDOK
		...
		&& (message[6] == 'K')) {
	    sppMessage = new SppMessage(BluetoothConstant.TYPE_GetFl_YFLRDOK, 0,
		    0, 0);
	}
	// YERROR
	    ...
	    sppMessage = new SppMessage(BluetoothConstant.TYPE_GetFl_YERROR, 0, 0,
		    0);
	} else {
